...
const routes: Routes = [
	...
	{ path: "author/book/:book_uuid", component: AuthorBookDashboardPageComponent },
	{ path: "author/:author_uuid/book/:book_uuid", component: AuthorBookDashboardPageComponent },
	{ path: "author/book/:book_uuid/details", component: AuthorBookPageComponent },
	{ path: "author/:author_uuid/book/:book_uuid/details", component: AuthorBookPageComponent },
